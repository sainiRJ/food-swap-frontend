...
import BgImg2 from "../../../../assets/images/bgImg.jpg";
...
function Login() {
  ...
  return (
    <div className={styles.Loginseprator}>
      <div className={styles.left}>
        <img src={BgImg1} alt="" className={styles.left} />
      </div>
      <div className={styles.right}>
        <img src={BgImg2} alt="" className={styles.right} />
      </div>
