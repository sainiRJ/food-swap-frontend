...
function Signup() {
  ...
  <div className="w-1/3 h-auto bg-white flex-row gap-4 p-4  min-w-80 rounded-2xl">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="password mb-2">
          <input 
            ...
            onBlur={handleBlur}
            onChange={handleChange}
            className="bg-gray-50 border border-gray-300 text-gray-900 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
